 ...
 */
class m170912_153719_create_shop_related_assignments_table extends Migration {
    public function up() {
        ...
        $this->addForeignKey('{{%fk-shop_related_assignments-product_id}}', '{{%shop_related_assignments}}', 'product_id', '{{%shop_product}}', 'id', 'CASCADE', 'RESTRICT');
        $this->addForeignKey('{{%fk-shop_related_assignments-related_id}}', '{{%shop_related_assignments}}', 'related_id', '{{%shop_product}}', 'id', 'CASCADE', 'RESTRICT');
    }
