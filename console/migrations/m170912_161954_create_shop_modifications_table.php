 ...
 */
class m170912_161954_create_shop_modifications_table extends Migration {
    public function up() {
        ...
        $this->addForeignKey('{{%fk-shop_modifications-product_id}}', '{{%shop_modifications}}', 'product_id', '{{%shop_product}}', 'id', 'CASCADE', 'RESTRICT');
    }
