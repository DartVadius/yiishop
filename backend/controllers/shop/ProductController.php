...
use core\entities\product\Modification;
...
use core\services\management\ProductManagementService;
...
class ProductController extends Controller {
    ...
    public function __construct($id, $module, ProductManagementService $service, $config = []) {
