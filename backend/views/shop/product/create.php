...
/* @var $model \core\forms\management\product\ProductCreateForm */
...
<div class="product-create">
        ...
        <div class="col-md-6">
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    <?= $form->field($model->categories, 'additional')->checkboxList($model->categories->categoriesList()) ?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="box box-default">
                ...
                <div class="box-body">
                    <?= $form->field($model->tags, 'exist')->checkboxList($model->tags->tagsList()) ?>
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <?php foreach ($model->characteristicsValues as $i => $value): ?>
